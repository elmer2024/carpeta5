...
//					$result = mysql_query($strSQL);
                    ...
                    $query="INSERT INTO nosotros2 (tipo,id2,nombre,descripcion,correo,orden,rubro,url2,descrip2,foto2,dueno, fecha, adultos, ninos, telef)
                    VALUE('$tipo','$id2','$nombre','$mensaje','$email','$orden','$rubro','$url2','$desc2','$fot2','$duen','$fecha','$adultos','$ninos','$telef')";
