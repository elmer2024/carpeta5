...
//		}
                ...
                <div class="c-menu">
                    ...
                    <nav class="menu">
                        <ul>
                            ...
                            <li onmouseover="toggleOverlay()" onMouseOut="hideOverlay()"><a href="serviciostodo2.php">SERVICIOS<svg width="20" height="16" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg></a>
								<div id="overlay" class="overlay">
									<ol>
										<li><a href="servi1.php?id=204">Capacitaciones</a></li>
										
										<li><a href="servi1.php?id=202">Consultor&iacute;as</a></li>
										
										<li><a href="servi1.php?id=153">Asesoramiento</a></li>
										<li><a href="servi1.php?id=224">Coaching ICI Per&uacute;</a></li>
										<li><a href="servi1.php?id=157">Proyectos</a></li>
									</ol>
								</div>		
							</li>
		...
		<script>
			...
			function keepOverlayActive() {
				// Uncomment the line below if you want to keep the overlay active on list item hover
				// toggleOverlay();
			}
	
			function handleItemClick(item) {
				// Uncomment the line below if you want to keep the overlay active when an item is clicked
				// toggleOverlay();
