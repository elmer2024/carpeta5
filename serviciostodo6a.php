...
<body>
    ...
    <section id="contenedor-titulo">
        <div class="container">
            <h2>modalidad hibrida: en las empresa y en tiempo real</h2>
        </div>
    </section>
    ...
    <section id="con-servicios">
        <div class="container">
          ...
          $result= mysqli_query($bdCondor,"SELECT *  FROM nosotros WHERE tipo = 'main3' order by orden DESC limit 0,30  ");
          while ( $product=mysqli_fetch_array($result)) {
          ?>    
		       <div class="grid-servicios">
					<div class="maneja1">
						  <a href="serviciostodo3b6.php?id=<?php echo $product['camp0']; ?>">
