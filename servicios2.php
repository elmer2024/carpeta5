...
<body>
    ...
    <section id="con-det-servicios">
        <div class="container">
			...
			<?
			$cadenaSQL = "SELECT camp0, tipo, titulo, foto, descripcion, orden, url2, descrip2 FROM nosotros WHERE tipo = 'c2' order by orden DESC ";
			...
			?>
				<div class="grid-servicios">
				  <a href="servicios1b.php?id=<? echo $row["camp0"]; ?>"><img src="img/<? echo $row["foto"]; ?>" alt=""></a>
